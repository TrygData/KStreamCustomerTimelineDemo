...
3) Run this code
 */
//public class KafkaStreamsAvroPartitions {
//
...
//
//        KStream<Integer, GenericRecord> callDetailStream = kStreamBuilder.stream(integerSerde, valueGenericAvroSerde, TERM_CALL_DETAIL_TOPIC);
//        //callDetail.print();
//        GlobalKTable<Integer, GenericRecord> callTypeKTable = kStreamBuilder.globalTable(integerSerde, valueGenericAvroSerde, CALL_TYPE_TOPIC);
//
...
//        callDetailAndTypeType.to("TEST2");
//
...
//        System.out.println("CISCO_WHOLE_SCHEMA1: " + CISCO_WHOLE_SCHEMA.toString());
//        System.out.println("CISCO_WHOLE_SCHEMA: " + CISCO_WHOLE_SCHEMA);
//        GenericRecord ciscoWhole = new GenericData.Record(CISCO_WHOLE_SCHEMA);

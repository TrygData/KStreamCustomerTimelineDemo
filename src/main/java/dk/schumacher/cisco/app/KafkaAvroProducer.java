...
//
//        for (int i = 1; i < 20; i++) {
//            GenericRecord callDetail = new GenericData.Record(TERM_CALL_DETAIL_SCHEMA);
...
//            producer.send(new ProducerRecord<Integer, GenericRecord>(TERM_CALL_DETAIL_TOPIC, new Integer(i), callDetail));
//
//            GenericRecord callType = new GenericData.Record(CALL_TYPE_SCHEMA);
//            callType.put("callTypeId", generate_agentSkillTargetID(i));
//            callType.put("enterpriseName", "Call type Description: " + i);
//            System.out.println(callType);
//            producer.send(new ProducerRecord<Integer, GenericRecord>(CALL_TYPE_TOPIC, new Integer(i), callType));
//
//
//        }
//
